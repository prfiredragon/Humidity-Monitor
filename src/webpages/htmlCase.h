...
const char HTML_FOOT[] PROGMEM = R"rawliteral(
        <figure class="text-center">HUMIDITY SENSOR V0.0.1 By <a href="https://github.com/prfiredragon/" target="_blank">Roberto Rodriguez</a> </br>form the work of </br>DALY BMS to MQTT V0.4.9 By <a href="https://github.com/softwarecrash/"
