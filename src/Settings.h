...
public:
  ...
  int _default_dry_val = 684;
  int _default_wet_val = 394;
  ...
  void load()
  {
    ...
    if (_valid)
    {
      ...
      _default_dry_val = readShort(0x106);
      _default_wet_val = readShort(0x10C);
    }
  ...
  void save()
  {
    ...
    writeShort(_default_dry_val, 0x106);
    writeShort(_default_wet_val, 0x10C);
